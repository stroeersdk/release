Pod::Spec.new do |spec|
  ...
  spec.source             = { :http => "https://github.com/stroeersdk/release/raw/refs/heads/main/Specs/YieldloveAdIntegration/10.5.2/yieldlove-ad-integration-10.5.2.tgz" }
  ...
  spec.subspec 'Consent' do |consent|
    ...
    consent.dependency     'ConsentViewController', '~>7.12.0'
  end
