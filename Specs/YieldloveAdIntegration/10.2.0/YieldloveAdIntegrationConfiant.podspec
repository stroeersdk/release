Pod::Spec.new do |spec|
  ...
  spec.source             = { :http => "https://github.com/stroeersdk/release/raw/refs/heads/main/Specs/YieldloveAdIntegration/10.2.0/yieldlove-ad-integrationConfiant-10.2.0.tgz" }
  ...
  spec.subspec 'Gravite' do |gravite|
    ...
    gravite.dependency     'AATKit/Core','~>3.12'
