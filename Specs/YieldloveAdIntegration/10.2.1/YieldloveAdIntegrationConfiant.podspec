Pod::Spec.new do |spec|
  ...
  spec.source             = { :http => "https://github.com/stroeersdk/release/raw/refs/heads/main/Specs/YieldloveAdIntegration/10.2.1/yieldlove-ad-integrationConfiant-10.2.1.tgz" }
