Pod::Spec.new do |spec|
    ...
    spec.source             = { :http => 'https://github.com/stroeersdk/release/raw/refs/heads/main/Specs/YieldloveAdIntegration/9.10.0/yieldlove-ad-integrationConfiant-9.10.0.tgz' }
