Pod::Spec.new do |spec|
    ...
    spec.source             = { :http => 'https://github.com/stroeersdk/release/raw/refs/heads/main/Specs/YieldloveAdIntegration/10.0.0/yieldlove-ad-integrationConfiant-10.0.0T.tgz' }
