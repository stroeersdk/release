Pod::Spec.new do |spec|
  ...
  spec.source             = { :http => "https://github.com/stroeersdk/release/raw/refs/heads/main/Specs/YieldloveAdIntegration/1.1.2/yieldlove-ad-integrationConfiant-1.1.2.tgz" }
