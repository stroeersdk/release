Pod::Spec.new do |spec|
  ...
  spec.source             = { :http => "https://slabs-yieldlove-ad-integration.s3.eu-central-1.amazonaws.com/ios/yieldlove-ad-integrationConfiant-10.3.0.tgz" }
