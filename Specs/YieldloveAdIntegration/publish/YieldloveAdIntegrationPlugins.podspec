Pod::Spec.new do |spec|
  ...
  spec.source             = { :http => "https://github.com/stroeersdk/release/raw/refs/heads/main/Specs/YieldloveAdIntegration/publish/yieldlove-ad-integration-publish.tgz" }
  ...
  spec.subspec 'Consent' do |consent|
    ...
    consent.dependency     'ConsentViewController', '~>7.12.9'
  end
