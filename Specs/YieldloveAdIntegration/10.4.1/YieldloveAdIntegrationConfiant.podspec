Pod::Spec.new do |spec|
  ...
  spec.source             = { :http => "https://github.com/stroeersdk/release/raw/refs/heads/main/Specs/YieldloveAdIntegration/10.4.1/yieldlove-ad-integrationConfiant-10.4.1.tgz" }
